...
public class ELoginPage extends BasePage {

    private static SelenideElement emailInput = $("#email"),
            passwordInput = $("#password"),
            loginButton = $("#loginButton"),
            createAccountButton = $(By.xpath("//a[contains(@href,'/programs/register')]//span[contains(@class,'button')]")),
    ...
    public void clickCreateBtn() { createAccountButton.click(); }
